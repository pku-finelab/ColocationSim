 ...
 */
public class CloudSimColocationGoogle {
    public static String DCName = "google";
    public static int USERID = 955;
    public static double beStartAt = 120;
    public static int beRepeat = 30;
    public static int beRepeatInterval = 3;
    public static int jobNumOnce = 1;
    public static int vmNum = 17;
    static String lcPath = "modules\\cloudsim-examples\\src\\main\\java\\org\\cloudbus\\cloudsim\\examples\\colocation\\google.json";
