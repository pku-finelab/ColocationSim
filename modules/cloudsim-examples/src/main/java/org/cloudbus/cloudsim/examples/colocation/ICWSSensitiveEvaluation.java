 ...
 */
public class ICWSSensitiveEvaluation {
    ...
    public static int jobNumOnce = 200;
    public static int vmNum = 50;
    ...
    static String basePath = "E:\\icwsData\\test2\\";
    ...
    public static void main(String[] args) {
        ...
        for ( String scheduleName :sches) {
            ALG = scheduleName;
            for (double sla = minSLA; sla <= maxSLA; sla = sla + step) {
                String outputPath = basePath + scheduleName+"-"+sla;
                File targetPath = new File(outputPath);
                boolean res = targetPath.mkdirs();
                if (res) {
                    runOnceWithSLA(sla, outputPath);
                } else {
                    Log.printLine("create path: "+ outputPath +" FAILED!");
                }

            }
        }
    }
    public static void runOnceWithSLA(double sla, String outPath){
