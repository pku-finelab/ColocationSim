 ...
 */
public class ICWSPressureTestEvaluation {
    ...
    public static int jobNumOnce = 500;
    ...
    static String bePath = "modules\\cloudsim-examples\\src\\main\\java\\org\\cloudbus\\cloudsim\\examples\\colocation\\oneBEJob.json";

    static String ALG = Constants.BUBBLEUP;
    static String basePath = "E:\\icwsData\\test\\";
