 ...
 */
public class SocialNetworkLcParagon {
    ...
    static String lcPath = "modules\\cloudsim-examples\\src\\main\\java\\org\\cloudbus\\cloudsim\\examples\\colocation\\socialnetwork-paragon-onlyentrypoint-has-qos.json";
    static String bePath = "modules\\cloudsim-examples\\src\\main\\java\\org\\cloudbus\\cloudsim\\examples\\colocation\\beJobs.json";
    static String outputPath = "E:\\test-open\\";
    static String ALG = Constants.LL;
    ...
    private static ColocationDatacenterBroker createBroker() {
        ...
        try {
            broker = new ColocationDatacenterBroker("ColocationBroker", DCName, ALG, outputPath);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
