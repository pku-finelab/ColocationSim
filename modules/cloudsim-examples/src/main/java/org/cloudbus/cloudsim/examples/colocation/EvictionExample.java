...
public class EvictionExample {
    ...
    static String lcPath = "E:\\PKU_DOC\\colocaton_research\\cloudsim-cloudsim-4.0\\modules\\cloudsim-examples\\src\\main\\java\\org\\cloudbus\\cloudsim\\examples\\colocation\\socialnetwork.json";
    ...
    public static void main(String[] args){
        ...
        //lc load generator
        EntrypointAPI api = new EntrypointAPI("service2", "api2");
        double lcStartAt = 100;
        double beStartAt = 159;
        double lowRPS = 1;
        double highRPS = 9;
        LoadGenerator loader = new BoostLoadGenerator(brokerId, api, lcStartAt, Constants.MINUTE, lowRPS, highRPS, 30, 5);
        broker.setLcLoadGenerator(loader);

        List<ColocationJob> jobs = createJobList(1);
        broker.setBeJobsForSchedule(jobs);
        broker.setWorkloadConfig(lcStartAt, beStartAt, 1);
    ...
    public static void printRequests(List<Request> requests, boolean printLog) {
