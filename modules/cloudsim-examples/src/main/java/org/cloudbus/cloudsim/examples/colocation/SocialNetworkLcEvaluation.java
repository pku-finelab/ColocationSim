...
public class SocialNetworkLcEvaluation {
    ...
    static String bePath = "modules\\cloudsim-examples\\src\\main\\java\\org\\cloudbus\\cloudsim\\examples\\colocation\\beJobs-long.json";

    static String ALG = Constants.DIAS;
    static String outputPath = "D:\\test\\"+ALG+"\\";
